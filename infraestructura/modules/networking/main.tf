...
# Restringe el SG default de la VPC: sin reglas de entrada ni salida (CKV2_AWS_12)
resource "aws_default_security_group" "default" {
  vpc_id = aws_vpc.main.id
  tags   = { Name = "${var.project_name}-${var.environment}-default-sg-locked", Environment = var.environment }
}
...
resource "aws_cloudwatch_log_group" "flow_logs" {
  #checkov:skip=CKV_AWS_158: KMS para log group de flow logs requiere CMK dedicada; fuera del alcance del demo
  #checkov:skip=CKV_AWS_338: Retención de 7 días suficiente para flow logs en demo; en prod se aumentaría
